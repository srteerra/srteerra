      ...
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              Hi, my name is Ángel and I am a{" "}
            ...
            <br />
            <p>
            I graduated with two degrees from the Technological University of Ciudad Juárez in 2023 with a T.S.U in the area of <span className="font-bold">Multiplatform Software Development</span> and <span className="font-bold">Engineering in Software Development and Management.</span>
            </p>
            <br />
            <p>
            I have been working in this field since then. Remotely in different national and international projects.
            </p>
            <br />
            <p>
            I have a wide range of hobbies and passions that keep me busy. From studying, playing sports, playing some instruments, I am always looking for new experiences and I love being involved and learning new things.
            </p>
            <br />
            <p>
